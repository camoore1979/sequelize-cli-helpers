 ...
 * see: https://gist.github.com/zorrodg/c349cf54a3f6d0a9ba62e0f4066f31cb#comments
 * 
 * This will NOT work in Node 8.4.0, is working for me in 10.5.0
 */

/**
 * TODO: would be possible to use this, but would have to rewrite the way that inquirere is used
 * to create a single prompt sequence that is executed together
 */
...
function executeWithInput(
  ...
  const {
    env = null, timeout = 100, maxTimeout = 10000 
  } = opts;
